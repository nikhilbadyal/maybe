...
class Api::V1::BaseController < ApplicationController
  ...
  def_param_group :pagination_params do
    param :page, :number, desc: "Page number for pagination", required: false, example: 1
    param :per_page, :number, desc: "Number of items per page (max 100, default 25)", required: false, example: 25
  end

  def_param_group :date_range_filter do
    param :start_date, Date, desc: "Filter from this date (YYYY-MM-DD)", required: false, example: "2024-01-01"
    param :end_date, Date, desc: "Filter to this date (YYYY-MM-DD)", required: false, example: "2024-12-31"
  end
