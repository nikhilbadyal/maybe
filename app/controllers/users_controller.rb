  ...
  private
    ...
    def user_params
      params.require(:user).permit(
        ...
        :show_sidebar, :default_period, :show_ai_sidebar, :ai_enabled, :theme, :set_onboarding_preferences_at, :set_onboarding_goals_at, :balance_sheet_sort,
        family_attributes: [ :name, :currency, :country, :locale, :date_format, :timezone, :use_data_provider, :id ],
        goals: []
      )
    end
