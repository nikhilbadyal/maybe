Apipie.configure do |config|
  ...
  # Enable parameter validation - validate implicitly wraps action methods
  config.validate = :implicitly
  config.validate_value = true
  config.validate_presence = true
  config.validate_key = false  # Don't enforce strict key validation for flexibility
  config.process_params = true  # Enable parameter processing
