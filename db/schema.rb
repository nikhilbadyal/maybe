...
ActiveRecord::Schema[8.0].define(version: 2025_08_26_073723) do
  ...
  create_table "families", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.boolean "use_data_provider", default: true, null: false
  end
  ...
  create_table "users", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.string "balance_sheet_sort", default: "name_asc", null: false
